                ...
                <div class="row mb-5">
                    <div class="card">
                        <div class="card-body text-center">
                            <h1 class="text-danger">Pangkas Rambut Kapuas Raya</h1>
                            <h5 class="text-info">TANGGAL {{ date('d-m-Y') }}</h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="card mb-5">
                            <div class="card-body text-center">
                                <a href="" class="btn btn-primary btn-lg me-3">DEWASA</a>
                                <a href="" class="btn btn-warning btn-lg">Anak-anak</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8">
                        <div class="card">
                            <h5>Total Dewasa : 5</h5>
                            <h5>Total Anak-anak : 5</h5>
                            <!--begin::Card body-->
