    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_user_form" class="form" method="POST" action="{{ url('/mitra/update') }}">
                    @csrf
                    <!--begin::Scroll-->
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="alamat_mitra" id="alamat_mitra"
    ...
    function getdata(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#id').val(response.id);
                $('#id2').val(response.id);
                $('#nama_mitra').val(response.nama);
                $('#alamat_mitra').val(response.alamat);
                $('#validasii').val(response.status);
            }
        });
    }
</script>
